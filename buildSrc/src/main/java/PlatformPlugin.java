...
public class PlatformPlugin implements Plugin<Project> {
	...
	public void apply(@NotNull Project project) {
		...
		Configuration development = configurations.create("development" + capitalize(project.getName()));
		...
		project.getComponents().named("java", softwareComponent -> {
			if(softwareComponent instanceof AdhocComponentWithVariants adhoc) {
				...
				throw new RuntimeException("Unexpected component type: " + softwareComponent.getClass().getName());
			}
		});
	}
